...
```jsx
import { Modal, DYVIX_MODAL_THEME, DYVIX_MODAL_VALIDATION_PRESET, DYVIX_GLOBAL_ANIMATION } from 'dyvix-ui'
  ...
  return(
        <Modal
          ...
          elements={[
            ...
            { type: "email", placeholder: "Email", validation: [DYVIX_MODAL_VALIDATION_PRESET.EMAIL], id: "email", name: "email", className: "ex-text", amount: 1 },
            { type: "password", placeholder: "Password", validation: [DYVIX_MODAL_VALIDATION_PRESET.PASSWORD], id: "password", name: "password", className: "ex-text", amount: 1 },
          ]}
